        ...
        <div className="py-[16px]">
            <div className="container flex justify-between items-center text-white text-sm">
                <div className="flex items-center gap-2 relative">
                    ...
                    <span className="whitespace-nowrap relative after:content-[''] after:w-[1px] after:h-5 after:bg-white after:mx-4 after:inline-block after:absolute after:top-1/2 after:translate-y-[-50%] after:right-[-1.5rem]">
